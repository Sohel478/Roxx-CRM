  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Manage client and target accounts, industries, and associated contacts.
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-12 text-center shadow-xs">
        ...
        <h3 className="text-base font-semibold text-slate-900">Companies Module</h3>
        <p className="text-sm text-slate-500 max-w-md mx-auto mt-1">
          Company accounts, contacts, and account-level timelines will be delivered in Phase 3.
        </p>
      </div>
    </div>
  );
